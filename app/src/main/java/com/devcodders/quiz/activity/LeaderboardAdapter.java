...
import com.devcodders.quiz.model.LeaderBoard;
...
public class LeaderboardAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder1, final int position) {
        if (holder1 instanceof ItemRowHolder) {
            ...
            String numberString = "";
            if (Math.abs(Float.parseFloat(leaderBoard.getScore()) / 1000000) > 1) {
                numberString = (Float.parseFloat(leaderBoard.getScore()) / 1000000) + "M";

            } else if (Math.abs(Float.parseFloat(leaderBoard.getScore()) / 1000) > 1) {
                numberString = (Float.parseFloat(leaderBoard.getScore()) / 1000) + "K";

            } else {
                numberString = leaderBoard.getScore();

            }
            holder.tvScore.setText(numberString);
    ...
    public void Rank1(TopHolder holder, LeaderBoard leaderBoard) {
        ...
        if (Math.abs(Float.parseFloat(leaderBoard.getScore()) / 1000000) > 1) {
           ...
           // System.out.println("System Balue::=" + numberString);

        } else {
            numberString = leaderBoard.getScore();

        }
        holder.tvScore1.setText(numberString);
    ...
    public void Rank2(TopHolder holder, LeaderBoard leaderBoard) {
        ...
        holder.tvScore2.setText(numberString);
    ...
    public void Rank3(TopHolder holder, LeaderBoard leaderBoard) {
        ...
        holder.tvScore3.setText(numberString);
