...
public class Constant {
    ...
    private static String DOMAIN_URL = "https://kheloaurjeeto.net/Quiz_Apps/newOne/Quiz_7_0_1/"; //domain or admin panel url
    // private static String DOMAIN_URL = "http://quizdemo.wrteam.in/"; //domain or admin panel url
    public static String QUIZ_URL = DOMAIN_URL + "api-v2.php";  //api url
    /////// PARAMETERS  ///////
    public static String AUTHORIZATION = "Authorization";
    public static String JWT_KEY = "yahallah5415@";
    ...
    public static String KEY_INAPPPURCHASE_MODE = "in_app_purchase_mode";
    ...
    public static String IN_APPURCHASE;
    ...
    public static String BATTLE_QUES = "10";
    ...
    public static int[] gradientBG = {R.drawable.gradient_category, R.drawable.gradient_cat_sky, R.drawable.gradient_cat_orange,
            R.drawable.gradient_cat_blue};
